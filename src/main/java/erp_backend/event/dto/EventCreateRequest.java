...
public class EventCreateRequest {
    ...
    private String eventType; // "COLLEGE_EVENT" or "EXTERNAL_EVENT"
    ...
    private String createdByReferenceId;

    public EventCreateRequest() {
    }

    public String getCreatedByReferenceId() {
        return createdByReferenceId;
    }

    public void setCreatedByReferenceId(String createdByReferenceId) {
        this.createdByReferenceId = createdByReferenceId;
    }
